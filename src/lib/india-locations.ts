...
export const DISTRICTS_BY_STATE: Record<string, string[]> = {
  ...
  "Odisha": [
    "Angul", "Balangir", "Balasore", "Bargarh", "Bhadrak", "Cuttack",
  ...
  "Uttar Pradesh": [
    ...
    "Kanpur Dehat", "Kanpur Nagar", "Kanshi Ram Nagar", "Kaushambi", "Kushinagar",
    ...
    "Sambhal", "Shravasti", "Siddharthnagar", "Sitapur", "Sonbhadra", "Sultanpur",
    "Unnao", "Varanasi",
  ],
  "Uttarakhand": [
...
export function getStateForDistrict(district: string): string | undefined {
...
export function getAllDistricts(): string[] {
  return Object.values(DISTRICTS_BY_STATE).flat();
}
